...
export function AdviceBusDiagram({ advice, summary }: AdviceBusDiagramProps) {
  if (advice.mode === "neutralComputed") {
    return (
      <figure className={styles.figure} aria-label={summary}>
        ...
        <div className={`${styles.bus} ${styles.busNeutral}`} aria-hidden="true">
  ...
  if (advice.recommendedSeatArea === "front" || advice.recommendedSeatArea === "back") {
    ...
    return (
      <figure className={styles.figure} aria-label={summary}>
        ...
        <div className={`${styles.bus} ${styles.busFrontBack}`} aria-hidden="true">
          <div className={`${styles.deckZone} ${recommendFront ? styles.deckRecommended : styles.deckSunny}`}>
          ...
          <div className={`${styles.deckZone} ${recommendFront ? styles.deckSunny : styles.deckRecommended}`}>
  ...
  return (
    <figure className={styles.figure} aria-label={summary}>
      ...
      <div className={styles.bus} aria-hidden="true">
        <div className={`${styles.zone} ${recommendLeft ? styles.zoneRecommended : styles.zoneSunny}`}>
          <span>lado esquerdo</span>
          <strong>{recommendLeft ? "melhor área" : "sol direto"}</strong>
        </div>
        <div className={styles.aisle} />
        <div className={`${styles.zone} ${recommendLeft ? styles.zoneSunny : styles.zoneRecommended}`}>
          <span>lado direito</span>
